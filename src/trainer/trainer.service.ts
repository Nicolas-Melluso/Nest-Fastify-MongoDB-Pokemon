...
export class TrainerService {
    ...
    async updateTrainer(trainerID: string, createTrainerDTO: CreateTrainerDTO): Promise<Trainer> {
    ...
    async tryCatchPokemonByPokedexID(trainerID: string, pokedexID: string): Promise<any> {
